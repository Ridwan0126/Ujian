      ...
      <Input
        ...
        rightIcon={
          <TouchableOpacity onPress={() => clearValue(label.toLowerCase(), id)}>
            <FeatherIcon name="x-circle" size={20} color="gray" />
          </TouchableOpacity>
        }
        leftIcon={
          deleteInfo ? (
            <View
              ...
              <TouchableOpacity
                ...
                onPress={() => deleteInfo(label.toLowerCase(), id)}>
                <FeatherIcon name="minus-circle" size={20} color="red" />
              </TouchableOpacity>
              <Text style={{marginLeft: 10, fontSize: 17}}>
                {label === 'Phone' ? 'Mobile' : 'Home'}
              </Text>
            </View>
          ) : null
        }
